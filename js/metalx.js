...
module.exports = class metalx extends Exchange {
    ...
    async fetchCurrencies (params = {}) {
        const response = await this.publicGetMarketAssets (params);
        // [
        //   {
        //       "id": "BTC",
        //       "code": "BTC",
    ...
    async fetchOHLCV (symbol, timeframe = '1m', since = undefined, limit = undefined, params = {}) {
        ...
        const response = await this.publicGetMarketOhlcv (this.extend (request, params));
    ...
    async cancelOrder (id, symbol = undefined, params = {}) {
        ...
        const response = await this.privatePutMarketOrdersCancel (this.extend (request, params));
        //
        //     -- LIMIT ORDERS --
        //     {
        //       "id": 2075345,
    ...
    async fetchOrder (id, symbol = undefined, params = {}) {
        ...
        const response = await this.privateGetMarketOrdersOrderId (this.extend (request, params));
        //   {
        //       "id": 1495144,
        //       "datetime": "2020-04-21T16:11:29.504Z",
        //       "timestamp": 1587485489504,
    ...
    async fetchMyTrades (symbol = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        const response = await this.privateGetMarketTradesMe (this.extend (request, params));
        return this.parseTrades (response, market, since, limit);
    }
